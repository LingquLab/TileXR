...
constexpr int64_t IPC_BUFF_MAX_SIZE = 512LL * 1024 * 1024;
...
struct ExtraFlag {
    ...
    static constexpr uint32_t CMO = 1 << 18;
};
...
struct CommArgs {
    ...
    GM_ADDR cmoTaskPtr = nullptr;  // device-side TileXRCmoTaskDesc*; nullptr means no pending CMO task
};
