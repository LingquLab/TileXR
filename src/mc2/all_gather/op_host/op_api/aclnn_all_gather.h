...
#ifndef OP_API_INC_ALL_GATHER
#define OP_API_INC_ALL_GATHER
...
/**
 * 算子功能：实现allGather
 * @brief aclnnAllGather的第一段接口，根据具体的计算流程，计算workspace大小。
...
/**
 * @brief aclnnAllGather的第二段接口，用于执行计算。
