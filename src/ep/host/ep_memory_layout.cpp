...
int TileXREpBuildMemoryDispatchReferenceConfig(int64_t rankSize, int64_t rank, int64_t bs, int64_t h,
    int64_t topK, int64_t moeExpertNum, int64_t sharedExpertNum, int64_t sharedExpertRankNum,
    int64_t globalBs, TileXR::TileXRDataType dtype, uint32_t blockDim,
    EpMemoryDispatchReferenceConfig *out)
{
    return TileXREpBuildMemoryDispatchReferenceConfig(rankSize, rank, bs, h, topK, moeExpertNum,
        sharedExpertNum, sharedExpertRankNum, globalBs, dtype, dtype, 0, blockDim, out);
}
    ...
    EpMemoryCombineReferenceConfig *out)
{
    ...
    next.sendCountNum = rank < sharedExpertRankNum ? rankSize : rankSize * next.moeExpertNumPerRank;
...
int TileXREpBuildMemoryCombineReferenceConfig(int64_t rankSize, int64_t rank, int64_t bs, int64_t h,
    ...
    EpMemoryCombineReferenceConfig *out)
{
    return TileXREpBuildMemoryCombineReferenceConfig(rankSize, rank, bs, h, topK, moeExpertNum,
        sharedExpertNum, sharedExpertRankNum, globalBs, dtype, 0, blockDim, out);
}
