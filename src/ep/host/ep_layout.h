...
int64_t TileXREpCombineDataAsFlagSendRoundOffset(int64_t totalBytes, int64_t rankSize, int64_t slotBytes,
    int64_t roundIndex);
int64_t TileXREpCombineDataAsFlagRemoteRecvWindowOffset(int64_t totalBytes, int64_t rankSize, int64_t slotBytes);
int64_t TileXREpCombineDataAsFlagRemoteRecvRoundOffset(int64_t totalBytes, int64_t rankSize, int64_t slotBytes,
    int64_t roundIndex);
