...
constexpr uint64_t kMoonEpFlagCombinePublishOnly = UINT64_C(1) << 3;
constexpr uint64_t kMoonEpFlagCombineConsumeOnly = UINT64_C(1) << 4;
...
constexpr int32_t kMoonEpCombineStatusUdmaInvalid = 3300;
constexpr int32_t kMoonEpCombineStatusUdmaSubmitBase = 3400;
constexpr int32_t kMoonEpCombineStatusUdmaCompletionBase = 3500;
