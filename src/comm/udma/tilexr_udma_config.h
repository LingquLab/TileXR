...
constexpr uint32_t TILEXR_UDMA_QP_CONFIG_WIRE_VERSION = 3;
constexpr uint32_t TILEXR_UDMA_MAX_QP_COUNT = 48;
...
static_assert(sizeof(UDMAQpConfigWireDescriptor) == 400,
