...
void TestCommValidation()
{
    ...
    commArgs = CrossNodeCommArgs();
    CheckInt("cross-node memory dispatch config", TileXREp::TileXREpValidateDispatchMemoryConfig(params, commArgs,
        &window), TileXR::TILEXR_SUCCESS);

    commArgs = CrossNodeCommArgs();
    commArgs.peerMems[1] = nullptr;
    CheckInt("cross-node memory dispatch missing peer mem", TileXREp::TileXREpValidateDispatchMemoryConfig(params,
        commArgs, &window), TileXR::TILEXR_ERROR_NOT_INITIALIZED);
    ...
    CheckInt("memory dispatch rejects tp", TileXREp::TileXREpValidateDispatchMemoryConfig(params, commArgs,
        &window), TileXR::TILEXR_ERROR_NOT_SUPPORT);

    params = ValidStaticQuantParams();
    commArgs = ValidCommArgs();
    CheckInt("memory dispatch rejects static quant", TileXREp::TileXREpValidateDispatchMemoryConfig(params,
        commArgs, &window), TileXR::TILEXR_ERROR_NOT_SUPPORT);

    params = ValidMemoryMxfp8Params();
    commArgs = ValidCommArgs();
    CheckInt("memory dispatch supports mxfp8 e4m3", TileXREp::TileXREpValidateDispatchMemoryConfig(params,
        commArgs, &window), TileXR::TILEXR_SUCCESS);

    params = ValidMemoryMxfp8Params();
    params.expandXOutDtype = TileXR::TILEXR_DATA_TYPE_FP8E5M2;
    CheckInt("memory dispatch supports mxfp8 e5m2", TileXREp::TileXREpValidateDispatchMemoryConfig(params,
        commArgs, &window), TileXR::TILEXR_SUCCESS);

    params = ValidMemoryMxfp8Params();
    params.dynamicScalesOut = nullptr;
    CheckInt("memory mxfp8 requires dynamic scales output", TileXREp::TileXREpValidateDispatchMemoryConfig(params,
        commArgs, &window), TileXR::TILEXR_ERROR_PARA_CHECK_FAIL);

    params = ValidMemoryMxfp8Params();
    params.expandXOutDtype = TileXR::TILEXR_DATA_TYPE_INT8;
    CheckInt("memory mxfp8 requires fp8 output dtype", TileXREp::TileXREpValidateDispatchMemoryConfig(params,
        commArgs, &window), TileXR::TILEXR_ERROR_PARA_CHECK_FAIL);
    ...
    CheckInt("memory dispatch supports shared experts", TileXREp::TileXREpValidateDispatchMemoryConfig(params,
        commArgs, &window), TileXR::TILEXR_SUCCESS);
    ...
    params.activeMaskType = TileXREp::TILEXR_EP_ACTIVE_MASK_TOKEN;
    commArgs = ValidCommArgs();
    CheckInt("memory token mask requires pointer", TileXREp::TileXREpValidateDispatchMemoryConfig(params,
        commArgs, &window), TileXR::TILEXR_ERROR_PARA_CHECK_FAIL);

    params = ValidV2Params();
    params.activeMaskType = TileXREp::TILEXR_EP_ACTIVE_MASK_NONE;
    commArgs = ValidCommArgs();
    CheckInt("memory none mask rejects pointer", TileXREp::TileXREpValidateDispatchMemoryConfig(params,
        commArgs, &window), TileXR::TILEXR_ERROR_PARA_CHECK_FAIL);
    ...
    commArgs = ValidCommArgs();
    CheckInt("memory expert mask supported", TileXREp::TileXREpValidateDispatchMemoryConfig(params,
        commArgs, &window), TileXR::TILEXR_SUCCESS);
    ...
    CheckInt("memory supports multiple ranks per shared expert",
        TileXREp::TileXREpValidateDispatchMemoryConfig(params, commArgs, &window), TileXR::TILEXR_SUCCESS);

    params.sharedExpertRankNum = 3;
    CheckInt("memory rejects uneven shared expert groups",
        TileXREp::TileXREpValidateDispatchMemoryConfig(params, commArgs, &window),
        TileXR::TILEXR_ERROR_PARA_CHECK_FAIL);
